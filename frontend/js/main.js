...
socket.on("startedGame",(room)=>{
    ...
    player1 = new Player(room.players[0].x, room.players[0].y, 20, 60, 'blue');
    player2 = new Player(room.players[1].x, room.players[1].y, 20, 60, 'red');
...
socket.on("endGame",(room)=>{
    isGameStarted = false;
    message.innerText = `${room.winner === playerNo ? "You Win!" : "You Lose! sorry!"}`;
